...
namespace IconController
{
    public partial class MainWindow : Window
    {
        ...
        private Window _captureWnd; // 快捷键捕获弹窗
        ...
        {
            if (_captureWnd != null) return;
            _captureWnd = new Window
            {
                Title = "请按下新快捷键",
            ...
            _captureWnd.KeyDown += (s, e) =>
            {
                ...
                {
                    var newHotkey = mod + key.ToString();
                    _captureWnd.Close();
                    AskConfirm(newHotkey);
                }
            };
            _captureWnd.ShowDialog();
        }
                ...
                Content = new StackPanel
                {
                    Children =
                    {
                        ...
                        new StackPanel
                        {
                            ...
                            Children =
                            {
                                new Button { Content = "保存设置", Width = 90, Margin = new Thickness(5) }
                                    .Also(b => b.Click += (_, __) => { _s.Hotkey = newHotkey; dlg.Close(); }),
                                new Button { Content = "重新设置", Width = 90, Margin = new Thickness(5) }
